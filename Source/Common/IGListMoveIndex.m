...
- (BOOL)isEqual:(id)object {
    ...
    if ([object isKindOfClass:[IGListMoveIndex class]]) {
        const NSInteger f1 = self.from, f2 = [(IGListMoveIndex *)object from];
        const NSInteger t1 = self.to, t2 = [(IGListMoveIndex *)object to];
        return f1 == f2 && t1 == t2;
    }
    return NO;
}
...
- (NSComparisonResult)compare:(id)object {
    const NSInteger right = [(IGListMoveIndex *)object from];
